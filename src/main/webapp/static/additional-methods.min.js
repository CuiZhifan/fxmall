...
jQuery.validator.addMethod("tel",function(value,element){
    return this.optional(element) || /^((134|135|136|137|138|139|150|151|152|157|158|159|182|187|188|147|130|131|132|155|156|183|185|186|133|153|180|181|189|186|170)\d{8})$/i.test(value);
},"手机号码输入不正确");

jQuery.validator.addMethod("price",function(value,element){
    return this.optional(element) || /^([0]|[1-9][0-9]{0,6})([\.][\d]{1,2})?$/i.test(value);
},"金额输入不正确");

jQuery.validator.addMethod("int",function(value,element){
    return this.optional(element) || /^([0]|[1-9][0-9]{0,6})?$/i.test(value);
},"输入必须为正整数,最长7位数字");

jQuery.validator.addMethod("percent",function(value,element){
    return this.optional(element) || /^([0]|[1-9][0-9]?|[100])?$/i.test(value);
},"输入百分百必须为0到100");