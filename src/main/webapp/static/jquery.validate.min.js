...
(function ($) {
    $.extend($.validator.messages, {
        ...
        maxlength: $.validator.format("最多为 {0} 位"),
        minlength: $.validator.format("至少需要 {0} 位"),
        rangelength: $.validator.format("请输入 {0} 至 {1} 位的字符串"),
        range: $.validator.format("请输入一个 {0} 和 {1} 之间的值"),
